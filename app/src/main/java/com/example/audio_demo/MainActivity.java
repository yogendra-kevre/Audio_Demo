...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.teri);
        ...
        // seekbar for seek the particular point in our audio file

        final SeekBar audioSlider = findViewById(R.id.seekBar2);
        audioSlider.setMax(mediaPlayer.getDuration());

        //for increasing the progress bar

        new Thread(()->    new Timer().scheduleAtFixedRate(new TimerTask() {
                @Override
                public void run() {
                    audioSlider.setProgress(mediaPlayer.getCurrentPosition());
                }
            },0,100)
        ).start();
